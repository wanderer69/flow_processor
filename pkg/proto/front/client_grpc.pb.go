...
const (
	ClientConnector_Login_FullMethodName   = "/frontprocessorclient.ClientConnector/Login"
	ClientConnector_Connect_FullMethodName = "/frontprocessorclient.ClientConnector/Connect"
)
...
func (c *clientConnectorClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, ClientConnector_Login_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedClientConnectorServer) Login(context.Context, *LoginRequest) (*LoginResponse, error) {
...
func _ClientConnector_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientConnectorServer).Login(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ClientConnector_Login_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientConnectorServer).Login(ctx, req.(*LoginRequest))
	}
...
var ClientConnector_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "frontprocessorclient.ClientConnector",
	HandlerType: (*ClientConnectorServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Login",
			Handler:    _ClientConnector_Login_Handler,
		},
	},
